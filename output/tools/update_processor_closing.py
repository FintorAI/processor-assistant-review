...
def update_processor_closing(
    ...
    Call this tool during STEP_11 (Processor Workflow and Closing) as substep 11.2.
    ...
    if writes:
        _write_fields(loan_id, writes, substep="11.2", flags=flags, state=state, labels=FIELD_LABELS)
