"""update_processor_workflow — Tool for substep 12.1: Processor Workflow Update
...
def update_processor_workflow(
    ...
    Call this tool during STEP_12 (Processor Workflow and Closing) as substep 12.1.
    ...
    _write_fields(loan_id, writes, substep="12.1", flags=flags, state=state, labels=FIELD_LABELS)
