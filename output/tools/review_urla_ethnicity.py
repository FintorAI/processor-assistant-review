"""review_urla_ethnicity — Tool for substep 7.3: Ethnicity and ID Cross-Check
...
def review_urla_ethnicity(
    ...
    Call this tool during STEP_07 (1003 URLA Part 4) as substep 7.3.    Reads LOS: borrower_ethnicity, attachment_type, property_type, estate_held, manner_of_title    Reads Docs: Driver's License    Flags: Ethnicity Mismatch with ID (warning), Attachment Type Mismatch with Listing (warning), Estate Held Not Fee Simple (warning)    """
